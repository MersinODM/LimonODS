...
<script src="{{ asset('js/app/manifest.js') }}" type="application/javascript"></script>
<script src="{{ asset('js/app/vendor.js') }}" type="application/javascript"></script>
<script src="{{ asset('js/app/app.js') }}" type="application/javascript"></script>
</body>
</html>
